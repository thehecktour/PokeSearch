...
export default function PokemonCard({ name, spriteUrl, ability }) {
  return (
    <div className="flex h-80 w-64 flex-col justify-between rounded-2xl border border-zinc-700 bg-zinc-800/70 p-2 backdrop-blur-sm transition-colors hover:bg-zinc-700/70">
